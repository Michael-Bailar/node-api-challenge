...
- [x] Describe Middleware?
        Middleware is functions that you pass information to along a route to another function. You can have middleware preform actions on the payload and send it on to the next middleware or return it to your app. 
- [x] Describe a Resource?
        I think it's just the target of our requests.
- [x] What can the API return to help clients know if a request was successful?
        A status of 200
- [x] How can we partition our application into sub-applications?
        with routers. That way we can connect the sub-applications up to each other. 
